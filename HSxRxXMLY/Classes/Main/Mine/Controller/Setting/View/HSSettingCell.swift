...
class HSSettingCell: UITableViewCell {
    ...
    var model: HSSettingCellModel? { didSet { setModel() } }
...
extension HSSettingCell {
    ...
    func initCellUI() {
        ...
        let titleLab = UILabel.init().then {
    ...
    func setModel() {
        ...
        case .rightSwitch:
            ...
            // 设置开关
            if case let HSSettingCellType.rightSwitch(isOn) = cellType {
